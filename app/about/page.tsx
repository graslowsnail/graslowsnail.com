  ...
  return (
      ...
      <div className="flex flex-col items-center justify-center pt-20 px-6">
        <div className="">
          ...
          <p className="text-4xl mb-1 font-regular font-['Koulen']">ABOUT ME</p>

         <p className="text-md font-light mb-2"> Born and raised in Houston, I've discoverd the art of analog photography over the years.   </p>
